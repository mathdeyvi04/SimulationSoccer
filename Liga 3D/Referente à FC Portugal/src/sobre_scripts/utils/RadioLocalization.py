...
class RadioLocalization:
    ...
    def execute(self):
        ...
        self.script.batch_create(BaseAgent, ((a.i, a.p, a.m, u, a.t, False, u == 1) for u in range(1, 12)))
        self.script.batch_create(BaseAgent, ((a.i, a.p, a.m, u, "Opponent", False, False) for u in range(1, 12)))
        players: list[BaseAgent] = self.script.players
